...
public class Video extends BaseEntity {
  ...
  public Video buildVideoWithFiles(String title, String description, Integer yearLaunched, Float duration, List<Category> categories, List<Genre> genres, List<CastMember> castMembers, List<VideoFile> videoFiles) {
    super.generateUUID();
    this.setTitle(title);
  ...
  public Video(String title, String description, Integer yearLaunched, Float duration, List<Category> categories, List<Genre> genres, List<CastMember> castMembers){
    this.buildVideoWithoutFiles(title, description, yearLaunched, duration, categories, genres, castMembers);
  }

  public Video(String title, String description, Integer yearLaunched, Float duration, List<Category> categories, List<Genre> genres, List<CastMember> castMembers, List<VideoFile> videoFiles){
    this.buildVideoWithFiles(title, description, yearLaunched, duration, categories, genres, castMembers, videoFiles);
  }

  public Video buildVideoWithoutFiles(String title, String description, Integer yearLaunched, Float duration, List<Category> categories, List<Genre> genres, List<CastMember> castMembers) {
    super.generateUUID();
    this.setTitle(title);
    this.setDescription(description);
    this.setYearLaunched(yearLaunched);
  ...
  public void setTitle(String title) {
    if (title == null || title.length() == 0) throw new IllegalArgumentException("title is marked as non-null/non-empty but is null/empty");
    this.title = title;
  }
  ...
  public void setYearLaunched(Integer yearLaunched) {
    if (yearLaunched == null) throw new IllegalArgumentException("yearLaunched is marked as non-null but is null");
  ...
  public void setGenres(List<Genre> genres) {
    if (genres == null) throw new IllegalArgumentException("genres is marked as non-null but is null");
    this.genres = genres;
  }
  public void addGenre(Genre genre) {
    if (genre == null) throw new IllegalArgumentException("genre is marked as non-null but is null");
    this.genres.add(genre);
  }
  public void removegenre(Genre genre) {
    if (genre == null) throw new IllegalArgumentException("genre is marked as non-null but is null");
    this.genres.removeIf(g -> g.equals(genre));
  }
  ...
  public void setCastMembers(List<CastMember> castMembers) {
    if (castMembers == null) throw new IllegalArgumentException("castMembers is marked as non-null but is null");
    this.castMembers = castMembers;
  }
  public void addCastMember(CastMember castMember) {
    if (castMember == null) throw new IllegalArgumentException("castMember is marked as non-null but is null");
  ...
  public void setVideoFiles(List<VideoFile> videoFiles) {
    if (videoFiles == null) throw new IllegalArgumentException("videoFiles is marked as non-null but is null");
    this.videoFiles = videoFiles;
  }
  public void addVideoFile(VideoFile videoFile) {
    if (videoFile == null) throw new IllegalArgumentException("videoFile is marked as non-null but is null");
    this.videoFiles.add(videoFile);
  }
  public void removeVideoFile(VideoFile videoFile) {
    if (videoFile == null) throw new IllegalArgumentException("videoFile is marked as non-null but is null");
    this.videoFiles.removeIf(v -> v.equals(videoFile));
  }
}
